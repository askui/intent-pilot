...
def call_gpt_4_vision_preview_labeled(
    ...
    label_coordinates, img_base64_labeled = get_label_coordinates_and_base64_encoded_image(screenshots_dir, skip_some_draw_labels)
...
def call_ollama_vision_labeled(
    ...
    Args:
        ...
        messages (list): List of messages exchanged between the user and the assistant.
        screenshots_dir (Path, optional): The directory to save the screenshots. Defaults to "screenshots".
        skip_some_draw_labels (list, optional): List of labels to skip during image processing. Defaults to [].
    ...
    # on image on each prompt (Tested on MacBook Pro 32gb)
    del messages[-1]
